...
%{\sl \textbf{NetMedia Dept. Fraunhofer IAIS, Germany}} \hfill Jan 2017 - July 2017 \\
%Supervisor: \textit{Dr. Joachim Koehler} \\
%Working on Knowledge Graph based Langauge Models by combining the symbolic knowledge provided by %Knowledge Graphs with RNN Language Models. 
%----------------------------------------------------------------------------------------
%	CONFERENCES SECTION
%----------------------------------------------------------------------------------------
