...
img <- readChar("trainingimages.txt", 29*28*5000)
y <- readChar("traininglabels.txt", 2*5000)
testimg<- readChar("testimages.txt",29*28*1000)
...
y_test <- readChar("testlabels.txt",2*5000)
